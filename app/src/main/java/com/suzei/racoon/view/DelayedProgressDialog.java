...
public class DelayedProgressDialog extends DialogFragment {
    private static final int DELAY_MILLISECOND = 200;
    private static final int MINIMUM_SHOW_DURATION_MILLISECOND = 500;
    private static final int HEIGHT_SIZE_DP = 140;
    private static final int WIDTH_SIZE_DP = 120;
    ...
    public void onStart() {
        ...
        if (getDialog().getWindow() != null) {
            int px = (int) (WIDTH_SIZE_DP * getResources().getDisplayMetrics().density);
            int py = (int) (HEIGHT_SIZE_DP * getResources().getDisplayMetrics().density);
